void Pi0Theta(){
	...
	TFile* twoPi0= new TFile ("~/practice/simulation/ARH_Pi0_P_200MeV.root");
	TH1F*theta200=(TH1F*)twoPi0->Get("PHYS_Pi0Theta");
	theta200->GetYaxis()->SetRangeUser(0,1400);
	theta200->SetLineColor(kRed);
	
	TFile* threePi0= new TFile ("~/practice/simulation/ARH_Pi0_P_300MeV.root");
	TH1F*theta300 =(TH1F*)threePi0->Get("PHYS_Pi0Theta");
	theta300->SetLineColor(kOrange);

	TFile* fourPi0= new TFile("~/practice/simulation/ARH_Pi0_P_400MeV.root");
	TH1F*theta400=(TH1F*)fourPi0->Get("PHYS_Pi0Theta");
	theta400->SetLineColor(kYellow-5);

	TFile* fivePi0= new TFile("~/practice/simulation/ARH_Pi0_P_500MeV.root");
	TH1F*theta500=(TH1F*)fivePi0->Get("PHYS_Pi0Theta");
	theta500->SetLineColor(kTeal);

	TFile* sixPi0= new TFile("~/practice/simulation/ARH_Pi0_P_600MeV.root");
	TH1F*theta600=(TH1F*)sixPi0->Get("PHYS_Pi0Theta");
	theta600->SetLineColor(kCyan);

	TFile* sevenPi0= new TFile("~/practice/simulation/ARH_Pi0_P_700MeV.root");
	TH1F*theta700=(TH1F*)sevenPi0->Get("PHYS_Pi0Theta");
	theta700->SetLineColor(kMagenta);
	
	TFile* eightPi0= new TFile("~/practice/simulation/ARH_Pi0_P_800MeV.root");
	TH1F*theta800=(TH1F*)eightPi0->Get("PHYS_Pi0Theta");
	theta800->SetLineColor(kPink);
	
	TFile* ninePi0= new TFile("~/practice/simulation/ARH_Pi0_P_900MeV.root");
	TH1F*theta900=(TH1F*)ninePi0->Get("PHYS_Pi0Theta");
	theta900->SetLineColor(kViolet);

	TFile* tenPi0= new TFile("~/practice/simulation/ARH_Pi0_P_1000MeV.root");
	TH1F*theta1000=(TH1F*)tenPi0->Get("PHYS_Pi0Theta");
	theta1000->SetLineColor(kBlack);
