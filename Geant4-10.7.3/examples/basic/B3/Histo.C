void B3a(){
	...
	TString filename = "~/practice/Geant4-10.7.3/examples/basic/B3/B3a/build/scoring.root";
	// opening the file 
	TFile*f = TFile::Open(filename);
	
	// creating the histograms 
	TH1F*h1 = new TH1F("crystal_edep_eventId","",400,0,230);
	TH1F*h2 = new TH1F("crystal_edep_cell","",400,0,35);
	TH1F*h3 = new TH1F("crystal_edep_score","",400,0,0.56);

	TH1F*h4 = new TH1F("eventId","",400,0,230);
	TH1F*h5 = new TH1F("cell","",400,-0.2,1);
	TH1F*h6 = new TH1F("score","",400,0,TMath::Power(10,-27));
